<template>
    <div class="bg-black bg-opacity-0 text-gray-100 py-3.5 px-6 flex justify-between items-center">
      <!-- Logo -->
      <div class="flex items-center cursor-pointer">
        <a href="/">
          <img src="/src/assets/brand/bpkd.png" alt="Logo" class="h-[100px] w-auto">
        </a>
      </div>
