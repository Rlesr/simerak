            ...
            <div class="px-6 py-4 flex-shrink-0">
                <ol class="flex text-xs mt-[20px] mb-[10px] text-gray-500 font-semibold dark:text-white-dark">
                    ...
                    <li class="before:content-['/'] before:px-0.5">
                        <a href="/home/tutup/opd" class="text-black dark:text-white-light hover:text-black/70 dark:hover:text-white-light/70">Tutup Rekening Bank Lain</a>
                    </li>
                    <li class="before:content-['/'] before:px-0.5">
                ...
                <p class="text-sm mb-[10px]">Menu ini digunakan untuk melihat daftar menutup rekening Bank Lain</p>
