                    ...
                    <div class="flex justify-between items-center w-full overflow-x-auto">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="relative flex items-center border border-gray-300 rounded-md h-10 w-[200px] px-2">
                                ...
                                <!-- Tombol Clear -->
                                <button class="absolute  right-2 text-gray-500 hover:text-red-500 focus:outline-none" @click="clearDate" v-if="selectedDate">Clear</button>
                            </div>
            ...
            filteredData() {
                let filtered = this.sortedData;
                 ...
                 if (this.selectedDate) {
                    filtered = filtered.filter((item) => item.tanggalBuka === this.selectedDate);
                }
