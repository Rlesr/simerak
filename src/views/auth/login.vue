<template>
  <div class="app-body min-h-screen bg-[#7EA5EC] bg-cover bg-no-repeat bg-center bg-landing flex justify-end items-center pr-4" style="background-image: url('/src/assets/brand/image4.png');">
