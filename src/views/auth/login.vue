<template>
    <div class="page-wrapper">
        <div class="app-body min-h-screen flex flex-col md:flex-row justify-center md:justify-end items-center md:pr-4 px-4">
            <!-- Bagian Kiri -->
            <div class="w-full md:max-w-5md flex flex-col md:ml-[40px] items-center md:items-start mb-[50px] md:mb-[100px] px-4 md:px-6">
                <div class="mb-4">
                    <img src="/src/assets/brand/logo-simerak.png" alt="Logo Simerak" class="w-[200px] md:w-[300px] h-auto" />
                </div>
                <div class="text-white mt-4 text-center md:text-left">
                    <h1 class="text-3xl md:text-5xl font-bold mb-2">Sistem Informasi</h1>
                    <h1 class="text-3xl md:text-5xl font-bold mb-2">Manajemen Rekening Bank</h1>
                    <p class="text-base md:text-[21px] mb-2">Daerah Khusus Ibukota Jakarta</p>
                </div>
            </div>

            <!-- Bagian Kanan (Form Login) -->
            <div class="bg-[#7EA5EC] w-full md:w-[800px] p-6 md:p-8 shadow-lg rounded-3xl">
                <div class="text-center mb-4">
                    <h1 class="text-3xl md:text-5xl font-bold text-[#054083] mb-3">Login</h1>
                ...
                <form @submit.prevent="login">
                    <div class="mb-3">
                        <input
                            type="text"
                            class="form-control form-control-lg rounded-lg w-full p-2 border border-gray-300"
                    ...
                    <div class="mb-3 relative">
                        ...
                        <svg
                            ...
                            :class="['h-6 w-6 absolute right-3 top-3 cursor-pointer']"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="#044DA4"
                        >
                    ...
                    <div class="mb-3 flex items-center">
                        <input
                            type="text"
                            class="form-control form-control-lg mr-5 rounded-lg w-full p-2 border border-gray-300"
                            placeholder="Captcha"
                    ...
                    <button type="submit" class="w-full bg-[#F57900] text-white py-2 rounded-lg transition duration-200">Login</button>
                </form>
