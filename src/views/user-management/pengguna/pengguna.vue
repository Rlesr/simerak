        ...
        computed: {
            ...
            filteredData() {
                return this.data.filter((item) => {
                    ...
                    const matchesNIP = item.email.toLowerCase().includes(this.searchNIP.toLowerCase());
                    const matchesUsername = item.email.toLowerCase().includes(this.searchUsername.toLowerCase());
